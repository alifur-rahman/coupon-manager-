			  ...
			  <form action="" id="coupon_form">
                  <div class="row">
					...
					<?php endif; ?>
						...
						<?php endif; ?>
                            ...
                            <td><input type="color"  name="title_color" value="<?php echo $title_color; ?>" /></td>
                          </tr>
                        </table>
				...
				<?php endif; ?>
						...
						<?php endif; ?>
                            ...
                            <td><input type="color"  name="descp_color" value="<?php echo $description_color; ?>" /></td>
                          </tr>
                        </table>
				...
				<?php endif; ?>
						...
						<?php endif; ?>
                            ...
                            <td><input type="color"  name="name_color" value="<?php echo $name_color; ?>" /></td>
                          </tr>
                        </table>
		   ...
		   <!-- Expires -->
				    ...
				    <?php endif; ?>
						...
						<?php endif; ?>
                            ...
                            <td><input value="<?php echo $terms_color; ?>" type="color"  name="terms_color" /></td>
                          </tr>
                        </table>
                        <br>
					...
					<select name="promo" id="promo" class="form-control">
                        ...
                        <input type="text" value="<?php echo $promoCode; ?>"  name="promoCode" id="promoCode" class="form-control" placeholder="" />
  ...
  <script type="text/javascript">
		$(document).ready(function(){
			...
			$("#save_template").click(function(){
				...
				$("#save_coupon").show();
				$.ajax({
					url: "save.php?type=template&lay=0",
					type: "post",
			...
			$("#save_coupon").click(function(){
				...
				$("#save_coupon").hide();
				$.ajax({
					url: "save.php?type=coupon&lay=0",
					type: "post",
					data: $("#coupon_form").serialize(),
					success: function (response) {
						if(response.includes("Error")){
			...
			function createCoupen(){
				...
				if(promo == "barcode"){
					...
					result2.append("<div class='top-full'><div class='al-m-bg'><div class='col al-logo'><img src='<?php echo $logo; ?>' id='vertical_logo' class='img img-responsive vertical_logo  float-right' /><p class='vertical_expire'><b>"+ expire_title +"<span>mm/dd/yyy</span>" + expire + "</b></p></div><div class='row mt-2'><div class='col-6 a-name'><div><p class='vertical_name'>" + name + "</p></div></div><div class='col-6 al-title'><p class='vertical_title'>" + title + "</p></div><div class='col-12'><p class='vertical_descp'>" + description  +"</p></div></div></div></div><div class='bottom-full'><div class='row pt-3'><div class='col-12'><div class='al-promo-code'><p class='vertical_promo'><b>Promo Code</b> : " + promoCode.val() + "</p><img src='" + promoCodeURl + "' class='img img-responsive vertical_promo_img' id='vertical_promo_img' /></div></div><div class='col-12'><p class='vertical_terms'><b>Terms & Conditions : </b><br />" + terms + "</p></div></div></div>"
					);
