		  ...
		  <div class="row lay-droupdown">
				<div class="col-md-12">
					<nav class="nav justify-content-center">
					  ...
					  <a class="nav-link active" href="lay1.php">Layout 2</a>
  ...
  <script type="text/javascript">
		$(document).ready(function(){
			...
			$("#save_template").click(function(){
				...
				$("#save_coupon").show();
				$.ajax({
					url: "save.php?type=template&lay=1",
					type: "post",
			...
			$("#save_coupon").click(function(){
				...
				$("#save_coupon").hide();
				$.ajax({
					url: "save.php?type=coupon&lay=1",
					type: "post",
					data: $("#coupon_form").serialize(),
					success: function (response) {
						if(response.includes("Error")){
			...
			function createCoupen(){
				...
				if(promo == "barcode"){
					...
					result2.append("<div class='top-full'><div class='al-m-bg'><div class='col-12 a-name'><div><p class='vertical_name'>" + name + "</p></div></div><div class='col-12 al-purches vertical_title'>" + title + "<p class='vertical_descp'>" + description  +"</p></div><div class='col-12 text-center pt-1 pb-2'><p style='color: #eee;'></p><p class='vertical_expire'><b>"+ expire_title +" <span>mm/dd/yyy</span>" + expire + "</b></p></div><div class='col al-logo'><img src='<?php echo $logo; ?>' id='vertical_logo' class='img img-responsive vertical_logo  float-right' /></div></div></div><div class='bottom-full'><div class='row pt-1'><div class='col-12'><div class='al-promo-code'><p class='vertical_promo'><b>Promo Code</b> : " + promoCode.val() + "</p><img src='" + promoCodeURl + "' class='img img-responsive vertical_promo_img' id='vertical_promo_img' /></div></div><div class='col-12'><p class='vertical_terms'><b>Terms & Conditions : </b><br />" + terms + "</p></div></div></div>"
					);
