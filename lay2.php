		  ...
		  <div class="row lay-droupdown">
				<div class="col-md-12">
					<nav class="nav justify-content-center">
					  ...
					  <a class="nav-link active" href="lay2.php">Layout 3</a>
            ...
            <div class="col-md-6 al-max-mar">
			  <form action="" id="coupon_form">
				...
				<?php else: ?>
                         <input type="text" class="form-control" placeholder="Your Next Purchase" value="We're Extending Out Discount to you on your next purchase" name="description" id="description" />
				<?php endif; ?>
		   ...
		   <!-- Expires -->
					...
					<select name="promo" id="promo" class="form-control mb-2">
                         <?php if($promo == "promo"){
							$newpromo = "selected";
						}
				    ...
				    <input type="text" name="promoCode-title" id="promoCode-title" class="form-control mt-2" placeholder="Code Title" value="USE COUPON CODE IN-STORE"/>
  ...
  <script type="text/javascript">
		$(document).ready(function(){
			...
			$("#save_template").click(function(){
				...
				$("#save_coupon").show();
				$.ajax({
					url: "save.php?type=template&lay=2",
					type: "post",
			...
			$("#save_coupon").click(function(){
				...
				$("#save_coupon").hide();
				$.ajax({
					url: "save.php?type=coupon&lay=2",
					type: "post",
					data: $("#coupon_form").serialize(),
					success: function (response) {
						if(response.includes("Error")){
			...
			function createCoupen(){
				...
				var promoCode_title = $('#promoCode-title').val();
				...
				if(promo == "barcode"){
					...
					result2.append("<div class='top-full'><div class='al-m-bg'><div class='col al-logo'><img src='<?php echo $logo; ?>' id='vertical_logo' class='img img-responsive vertical_logo  float-right' /><p class='vertical_expire'><b>"+ expire_title +" <span>mm/dd/yyy</span>" + expire + "</b></p></div><div class='row mt-2 pb-2'><div class='col-12 a-name'><div><p class='vertical_name'>" + name + "</p></div></div><div class='col-6 al-title'><p class='vertical_title'>" + title + "</p></div><div class='col-6 al-extending'><p class='vertical_descp'>" + description  +"</p></div><div class='col-12'></div></div></div></div><div class='bottom-full'><div class='row pt-3'><div class='col-12 al-use-cupon'><p>"+ promoCode_title +"</p></div><div class='col-12 p-0'><div class='al-promo-code'><p class='vertical_promo'><b>Promo Code</b> : " + promoCode.val() + "</p><img src='" + promoCodeURl + "' class='img img-responsive vertical_promo_img' id='vertical_promo_img' /></div></div><div class='col-12 p-0'><p class='vertical_terms'><b>Terms & Conditions : </b><br />" + terms + "</p></div></div></div>"
					);
