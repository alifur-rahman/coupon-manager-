		...
		$(document).ready(function(){
			...
			function createCoupen(){
				...
				//var codeimg = '<?php echo $couponData['codeim']; ?>';
					...
					result.append("<div class='col-12'><div class='top-full'><div class='al-m-bg'><div class='col al-logo'><img  src='" + logo + "'  id='vertical_logo' class='img img-responsive vertical_logo  float-right'><p class='vertical_expire' ><b>Expires:<span>"+ expire +"</span></b></p></div><div class='row mt-2'><div class='col-6 a-name'><div><p class='vertical_name'>" + name + "</p></div></div><div class='col-6 al-title'><p class='vertical_title'>" + title + "</p></div><div class='col-12'><p class='vertical_descp' >" + description  +"</p></div></div></div></div></div><div class='bottom-full'><div class='row pt-3'><div class='col-12'><div class='al-promo-code'><p class='vertical_promo'><b>Promo Code</b> : " + promoCode + "</p><img src='" + promoCode +"' class='img img-responsive vertical_promo_img' id='vertical_promo_img' /></div></div><div class='col-12'><p class='vertical_terms'><b>Terms & Conditions : </b><br />"+ terms +"</p></div></div></div>");
					...
					result2.append("<div class='col-12'><div class='top-full'><div class='al-m-bg'><div class='col al-logo'><img  src='" + logo + "'  id='vertical_logo' class='img img-responsive vertical_logo  float-right'><p class='vertical_expire' ><b>Expires:<span>"+ expire +"</span></b></p></div><div class='row mt-2'><div class='col-6 a-name'><div><p class='vertical_name'>" + name + "</p></div></div><div class='col-6 al-title'><p class='vertical_title'>" + title + "</p></div><div class='col-12'><p class='vertical_descp' >" + description  +"</p></div></div></div></div></div><div class='bottom-full'><div class='row pt-3'><div class='col-12'><div class='al-promo-code'><p class='vertical_promo'><b>Promo Code</b> : " + promoCode + "</p><img src='" + promoCode +"' class='img img-responsive vertical_promo_img' id='vertical_promo_img' /></div></div><div class='col-12'><p class='vertical_terms'><b>Terms & Conditions : </b><br />"+ terms +"</p></div></div></div>");
