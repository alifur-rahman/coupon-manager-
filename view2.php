...
.top-full {
	...
	background: linear-gradient(135deg, #fff0 5px, transparent 0) 0 5px, linear-gradient(-135deg, #f0dfbd00 6px, #e81212 0) 0 6px;
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function createCoupen(){
				...
				var promoCode_title = '<?php echo $couponData['promoCode_title']; ?>';
				...
				//var codeimg = '<?php echo $couponData['codeim']; ?>';
					...
					result.append('<div class="top-full"><div class="al-m-bg"><div class="col al-logo"><img src="' + logo +'" id="vertical_logo" class="img img-responsive vertical_logo  float-right"><p class="vertical_expire"><b>Expires: '+ expire +'</b></p></div><div class="row mt-2 pb-2"><div class="col-12 a-name"><div><p class="vertical_name">'+name+'</p></div></div><div class="col-6 al-title"><p class="vertical_title">'+title+'</p></div><div class="col-6 al-extending"><p class="vertical_descp" >'+description+'</p></div><div class="col-12"></div></div></div></div><div class="bottom-full"><div class="row pt-3"><div class="col-12 al-use-cupon"><p>'+promoCode_title+'</p></div><div class="col-12 p-0"><div class="al-promo-code"><p class="vertical_promo" ><b>Promo Code</b> : ' + promoCode +'</p><img src="' + promoCode +'" class="img img-responsive vertical_promo_img" id="vertical_promo_img" ></div></div><div class="col-12 p-0"><p class="vertical_terms" ><b>Terms &amp; Conditions : </b><br>'+terms+'</p></div></div></div>');
					...
					result2.append('<div class="top-full"><div class="al-m-bg"><div class="col al-logo"><img src="' + logo +'" id="vertical_logo" class="img img-responsive vertical_logo  float-right"><p class="vertical_expire"><b>Expires: '+ expire +'</b></p></div><div class="row mt-2 pb-2"><div class="col-12 a-name"><div><p class="vertical_name">'+name+'</p></div></div><div class="col-6 al-title"><p class="vertical_title">'+title+'</p></div><div class="col-6 al-extending"><p class="vertical_descp" >'+description+'</p></div><div class="col-12"></div></div></div></div><div class="bottom-full"><div class="row pt-3"><div class="col-12 al-use-cupon"><p>'+promoCode_title+'</p></div><div class="col-12 p-0"><div class="al-promo-code"><p class="vertical_promo" ><b>Promo Code</b> : ' + promoCode +'</p><img src="' + promoCode +'" class="img img-responsive vertical_promo_img" id="vertical_promo_img" ></div></div><div class="col-12 p-0"><p class="vertical_terms" ><b>Terms &amp; Conditions : </b><br>'+terms+'</p></div></div></div>');
