		...
		$(document).ready(function(){
			...
			function createCoupen(){
				...
				//var codeimg = '<?php echo $couponData['codeim']; ?>';
					...
					result.append('<div class="top-full"><div class="al-m-bg"><div class="col al-logo"><img src="'+logo+'" id="vertical_logo" class="img img-responsive vertical_logo  float-right"></div><div class="col-12 al-purches vertical_title"><span>'+title+'<sub>%</sub></span><p class="vertical_descp">'+ description  +' </p></div><div class="col-12 text-center pt-1 pb-2 al-desc vertical_terms"><p>'+terms+'</p><p class="vertical_expire"><b>Expires: '+expire+'</b></p></div></div></div><div class="bottom-full"><div class="row pt-3"><div class="col-12"><div class="al-promo-code"><p class="vertical_promo"><b>Promo Code</b> : '+ promoCode + '</p><img src="'+ promoCode + '" class="img img-responsive vertical_promo_img" id="vertical_promo_img" ></div></div></div></div>');
					...
					result2.append('<div class="top-full"><div class="al-m-bg"><div class="col al-logo"><img src="'+logo+'" id="vertical_logo" class="img img-responsive vertical_logo  float-right"></div><div class="col-12 al-purches vertical_title"><span>'+title+'<sub>%</sub></span><p class="vertical_descp">'+ description  +' </p></div><div class="col-12 text-center pt-1 pb-2 al-desc vertical_terms"><p>'+terms+'</p><p class="vertical_expire"><b>Expires: '+expire+'</b></p></div></div></div><div class="bottom-full"><div class="row pt-3"><div class="col-12"><div class="al-promo-code"><p class="vertical_promo"><b>Promo Code</b> : '+ promoCode + '</p><img src="'+ promoCode + '" class="img img-responsive vertical_promo_img" id="vertical_promo_img" ></div></div></div></div>');
